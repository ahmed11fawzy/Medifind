...
const { createMedicine, getMedicines, medicineUpdated, getAllNotExamineMedicine, getUserAddedMedicine, deleteMedicine , decrementQuantity } = require('../Controllers/medicineController.service.js')
