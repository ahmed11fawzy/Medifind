...
const { createMedicine, getMedicines, medicineUpdated, getAllNotExamineMedicine, getUserAddedMedicine, deleteMedicine, getAcceptedMedicines , decrementQuantity,searchMedicine } = require('../Controllers/medicineController.service.js')
